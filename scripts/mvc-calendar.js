			...
			calendar = $(caller).fullCalendar({
				...
				viewDisplay: function (view) {
					...
					if(view.name == 'month'){
						...
						if(cal_date_string == cur_date_string) { jQuery(caller + ' .fc-button-prev').addClass("fc-state-disabled"); }
						else { jQuery(caller + ' .fc-button-prev').removeClass("fc-state-disabled"); }
